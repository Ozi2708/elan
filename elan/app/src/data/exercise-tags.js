...
window.ED_TAGS = {
  ...
  's7-7':  { region:'proprioception', targets:['proprioception','force-bas'],         muscles:['fessiers','abducteurs'],           pattern:'abduction',          difficulty:2, load:'faible', position:'allonge',      side:'unilateral-chaque', flags:['floorTransition'] }, // clamshell B3
  's7-8':  { region:'proprioception', targets:['force-bas','force-tronc'],            muscles:['fessiers','ischios'],              pattern:'charniere',          difficulty:2, load:'moyen',  position:'allonge',      side:'bilateral',         flags:['floorTransition'] }, // pont B3
  's7-9':  { region:'proprioception', targets:['pied-tombant','proprioception'],      muscles:['tibial-anterieur'],                pattern:'mobilite',           difficulty:1, load:'faible', position:'assis',        side:'bilateral',         flags:[] }, // relevé pointe pied B3
