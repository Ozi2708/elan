...
window.ED_TAGS = {
  ...
  'xlb-4': { region:'lower', targets:['force-bas','equilibre'],              muscles:['quadriceps','fessiers'],   pattern:'squat',    difficulty:5, load:'moyen',  position:'debout-libre', side:'unilateral-chaque', flags:['fallRisk'] }, // squat 1 jambe assisté
  'xlb-5': { region:'lower', targets:['force-bas','equilibre'],              muscles:['quadriceps','fessiers'],   pattern:'fente',    difficulty:3, load:'moyen',  position:'debout-libre', side:'unilateral-chaque', flags:['fallRisk'] }, // montée sur step
  'xlb-6': { region:'lower', targets:['force-bas','force-tronc'],            muscles:['fessiers','ischios'],      pattern:'charniere',difficulty:3, load:'moyen',  position:'allonge',      side:'unilateral-chaque', flags:['floorTransition'] }, // pont 1 jambe
  'xlb-7': { region:'lower', targets:['force-bas'],                          muscles:['ischios'],                 pattern:'charniere',difficulty:4, load:'moyen',  position:'allonge',      side:'bilateral',         flags:['floorTransition'] }, // curl ischios glissé
  'xlb-8': { region:'lower', targets:['force-bas'],                          muscles:['ischios'],                 pattern:'charniere',difficulty:5, load:'eleve',  position:'quadrupedie',  side:'bilateral',         flags:['floorTransition'] }, // nordic excentrique
  'xlb-9': { region:'lower', targets:['force-bas','equilibre','proprioception'],muscles:['ischios','fessiers'],   pattern:'charniere',difficulty:4, load:'moyen',  position:'debout-libre', side:'unilateral-chaque', flags:['fallRisk'] }, // soulevé de terre 1 jambe
  'xlb-10':{ region:'lower', targets:['force-bas','equilibre'],              muscles:['mollets'],                 pattern:'mollet',   difficulty:3, load:'faible', position:'debout-appui', side:'unilateral-chaque', flags:[] }, // mollets 1 jambe
  'xlb-11':{ region:'lower', targets:['force-bas','force-tronc'],            muscles:['fessiers','ischios'],      pattern:'charniere',difficulty:3, load:'moyen',  position:'allonge',      side:'bilateral',         flags:[] }, // hip thrust chaise
  'xlb-12':{ region:'lower', targets:['force-bas','force-tronc'],            muscles:['fessiers','ischios'],      pattern:'charniere',difficulty:4, load:'moyen',  position:'allonge',      side:'unilateral-chaque', flags:[] }, // hip thrust 1 jambe
  'xlb-13':{ region:'lower', targets:['force-bas'],                          muscles:['adducteurs','quadriceps','fessiers'],pattern:'squat',difficulty:3, load:'moyen', position:'debout-libre', side:'bilateral',         flags:[] }, // squat sumo
  'xlb-14':{ region:'lower', targets:['force-bas','force-tronc'],            muscles:['adducteurs'],              pattern:'gainage',  difficulty:4, load:'moyen',  position:'allonge',      side:'unilateral-chaque', flags:['floorTransition'] }, // copenhagen assisté
